...
from Functions1 import create_design, Incorrelation_repetition, groupdifference_repetition, check_input_parameters, Excorrelation_repetition
...
if __name__ == '__main__':
    ...
    InputFile_name = "InputFile1_{}.csv".format(criterion)
